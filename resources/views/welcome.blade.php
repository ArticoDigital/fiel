...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-68442702-8"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-68442702-8');
</script>
			...
			@if(!Session::has('status'))
				...
				<div class="links">
					<a class="more" href="{{ route('social.auth', 'facebook') }}">Inscribirme con
						<svg class="svg" width="15px" height="30px" viewBox="0 0 15 30" version="1.1"
							 xmlns="http://www.w3.org/2000/svg"
							 xmlns:xlink="http://www.w3.org/1999/xlink">
							<g id="Artboard" transform="translate(-8.000000, 0.000000)" fill-rule="nonzero"
							   fill="#FFFFFF">
				...
				<p class="p">Y anda al día con nuestras promociones, eventos y regalos que #barsotano303 tiene para ti
					por
					un cliente
					fiel.</p>
			@else
				@if(Session::get('status') == 'old')
					<h1>Ya te encuentras registrado</h1>
					<p class="p">Pendiente, pronto tendrás notificaciones de promociones, eventos y regalos </p>
				@else
					<h1>¡Gracias por registraste!</h1>
					<p class="p">Pendiente, pronto tendrás notificaciones de promociones, eventos y regalos </p>
				@endif
			@endif
		</div>
